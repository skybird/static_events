...
function getProfitLevel(profit) {
    ...
    if (profit >= 4 && profit <= 5) {
        return {
            title: '没错，我就是李小龙寸拳的传人',
            contents: ['你是寸拳传人！', '此拳乃李小龙截拳道中的最高技艺，', '至简、至灵、至威、至猛，短距出拳，', '能让150公斤的“熊”脏腑爆裂，', '应声倒地！'],
            img: 'result_4.png'
        }
    }
    if (profit >= 6 && profit <= 7) {
        return {
